...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="container-fluid nomargin">
    <div class="col-md-12 col-xs-12 nomargin">
      <div class="col-md-7 col-sm-6 hidden-xs nomargin">
          ...
          <form>
           ...
           <div class="form-group row top-50">
             <div class="col-md-8 col-md-offset-2">
               ...
               <a href="dashboard.php"><p type="submit" class="btn boton-registro hvr-back-pulse">INGRESA</p></a>
             </div>
           </div>
           <div class="form-group row top-50">
             <div class="col-md-8 col-md-offset-2">
           ...
           <div class="form-group row top-50">
             <div class="col-md-8 col-md-offset-2 cuenta">
               ...
               <a href="index.php"><p class="nomargin"><strong>registrate aqui</strong></p></a>
